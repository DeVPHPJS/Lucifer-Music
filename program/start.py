...
async def start(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("℡ ᯓ 𝐋𝐔𝐂𝐈𝐅𝐄𝐑 • 🇪🇬", url=f"https://t.me/DeV_PHPJS"),
            ],
            [
                InlineKeyboardButton(
                    "- لـ لُِـوسـيـفُـر ☾ .", url=f"https://t.me/JJJ6D"
                ),
            ],
            [
                InlineKeyboardButton("♡اضف البوت الى مجموعتك♡", url=f"https://t.me/LucMusic_Bot?startgroup=true"),
            ]
         ]
     )
  )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓌹℡ ᯓ 𝐋𝐔𝐂𝐈𝐅𝐄𝐑 • 🇪🇬", url=f"https://t.me/DeV_PHPJS"),
            ],
            [
                InlineKeyboardButton(
            ...
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        url=f'https://t.me/LucMusic_Bot?startgroup=true'),
                        ],
                    ]
                )
            )
